...
namespace ed {
  ...
  private:
    ...
    double componentes[3]; //<! Array que guarda las componentes X,Y y Z del Vector3D
  ...
  public:
    ...
    */
    ...
    Vector3D(double v1arg, double v2arg, double v3arg){
      ...
      #ifndef NDEBUG
      assert((std::abs((componentes[0]) - (get1())) < COTA_ERROR) && (std::abs((componentes[1]) - (get2())) < COTA_ERROR) && (std::abs((componentes[2]) - (get3())) < COTA_ERROR));
      #endif
    };
    ...
    */
    ...
    Vector3D(Vector3D const &v) {
      componentes[0] = v.get1();
      componentes[1] = v.get2();
      componentes[2] = v.get3();
    ...
    */
    ...
    double get1()const{return componentes[0];};
    ...
    */
    ...
    double get2()const{return componentes[1];};
    ...
    */
    ...
    double get3()const{return componentes[2];};
