...
int main() {
	...
	// Creamos los procesos hijos y en cada uno de ellos realizamos una conexion con el espacio de memoria compartida
     ...
     for(i = 0; i<numerohijos;i++){
			...
			// Creamos una conexion entre el proceso hijo y la memoria compartida
